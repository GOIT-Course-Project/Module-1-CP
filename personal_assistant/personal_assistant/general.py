...
def help_command(*args):
    if CURRENT_MODE == '1' or CURRENT_MODE == '2':
        print(f"""In {CURRENT_MODES[CURRENT_MODE]} mode.
            You can see all records in your {CURRENT_MODES[CURRENT_MODE]} - just type {SHOW_ALL_COMMANDS} command
...
COMMANDS = {ADD_COMMANDS: add_command, GREETING_COMMANDS: greeting_command, SHOW_ALL_COMMANDS: show_all_command,
            ...
            SELECT_COMMANDS: select_command, EDIT_COMMANDS: edit_command, FIND_COMMANDS: find_command, BIRTHDAY_COMMANDS: birthday_command, SORT_COMMANDS: sort_command}
